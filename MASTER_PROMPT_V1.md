...
* **Total Spoken Words**: [e.g. 68 Words - Strictly 2.2 to 2.4 words/second]
* **Speaking Flow**: [100% continuous, unbroken natural sentences for 1-take recording]
...
* **VOICE-OVER (Audio)**: "[100% complete, standalone sentence that starts and finishes completely in Scene 1]"
* **⏱️ Pacing Check**: [e.g. 10 Words | ~4.2s speaking time | 100% Speakable ✅]
* **VISUAL ACTION**: "..."
...
* **VOICE-OVER (Audio)**: "[Complete standalone sentence, never broken from Scene 1]"
* **⏱️ Pacing Check**: [e.g. 14 Words | ~5.8s speaking time | 100% Speakable ✅]
* **VISUAL ACTION**: "..."
* **CAMERA**: "..."
* **ON-SCREEN TEXT (Optional)**: [If enabled: "✨ BOLD TEXT" / If disabled: Omit]
* **GOOGLE FLOW PROMPT**:
...
### 📱 INSTAGRAM & AFFILIATE LAUNCH KIT (READY TO COPY-PASTE)
...
"🔥 *LOOT DEAL ON MEESHO!* 🔥
👗 *[Product Title]*
✨ *Why you need it:* [1-line key benefit]
💰 *Meesho Price:* ₹[Price] (MRP: ₹[Original Price] - 70% OFF!)
⭐ *Fabric:* [Fabric name] | Super soft & daily comfort
